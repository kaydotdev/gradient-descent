...
if args.alg == "sgd":
    x_opt, x_hist, epochs = SGD(F, x0, args.epoch, args.hg, args.step, args.eps1, args.eps2, args.k, args.criteria)
elif args.alg == "momentum":
    x_opt, x_hist, epochs = Momentum(F, x0, args.epoch, args.hg, args.step, args.beta1, args.eps1, args.eps2, args.k, args.criteria)
elif args.alg == "nag":
    x_opt, x_hist, epochs = NAG(F, x0, args.epoch, args.hg, args.step, args.beta1, args.eps1, args.eps2, args.k, args.criteria)
elif args.alg == "adagrad":
    x_opt, x_hist, epochs = AdaGrad(F, x0, args.epoch, args.hg, args.step, args.eps1, args.eps2, args.vareps, args.k, args.criteria)
elif args.alg == "rmsprop":
    x_opt, x_hist, epochs = RMSProp(F, x0, args.epoch, args.hg, args.step, args.beta1, args.eps1, args.eps2, args.vareps, args.k, args.criteria)
elif args.alg == "adam":
    x_opt, x_hist, epochs = Adam(F, x0, args.epoch, args.hg, args.step, args.beta1, args.beta2, args.eps1, args.eps2, args.vareps, args.k, args.criteria)
